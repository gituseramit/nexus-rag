        ...
        <div className="relative z-10 p-12 flex flex-col h-full">
          ...
          <div className="mt-auto mb-20 max-w-lg">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex items-center gap-2 bg-[#1a2133]/60 backdrop-blur border border-white/5 px-4 py-2 rounded-lg text-sm text-[#8e919f]">
                <span className="material-symbols-outlined text-[#adc6ff] text-[18px]">speed</span>
                Lightning Fast
              </div>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 lg:p-12 relative">
        <div className="w-full max-w-md">
          ...
          <div className="mb-10 text-center lg:text-left">
            <h2 className="text-3xl font-bold font-geist mb-2">Welcome back</h2>
            <p className="text-[#8e919f]">Enter your credentials to access your workspace.</p>
          </div>
